  ...
  const [movieData, setMovieData] = useState([
    {
      ...
      trailer: "https://www.youtube.com/embed/aHeOQSB9rfY?si=PvpsFZELfNPtNqbK",
    },
    {
      id: Math.random(),
    ...
    },
    {
      ...
      rating: 3,
      description:
        "It's been two years since Leo Barnes (Frank Grillo) stopped himself from a thanks of thanks also biden free regrettable act of revenge on Purge Night   .",
    },
    {
      id: Math.random(),
    ...
    },
    {
      ...
      rating: 4,
      description:
        "With the newly acquired knowledge of the seemingly invulnerable creatures' weakness, grief-strick.",
    },
    {
      id: Math.random(),
      title: "Gravity",
      ...
      rating: 4,
      description:
        "Dr. Ryan Stone (Sandra Bullock) is a brilliant medical engineer on her first shuttle mission.",
    },
    {
      id: Math.random(),
      title: "Get Out",
      ...
      rating: 7,
      description:
        "Chris and his girlfriend Rose go upstate to visit her parents for you and me in film and thnks of american the weekend.",
    },
    {
      id: Math.random(),
      title: "X-MEN",
    ...
    },
    {
      ...
      rating: 5,
      description:
        "In Harry Potter's (Daniel Radcliffe's) sixth year at Hogwarts School of Witchcraft. ",
    },

    {
      ...
      rating: 6,
      description:
        "The parapsychologist Dr. Elise Rainier has nightmares with her childhood  and the diffical of her familyy and you in New Mexico,",
    },
